...
extern void IHT_calc3DByteDepthUniformHist_ASM(const Mat* image, Mat* hist);
extern void IHT_calc3DByteDepthBackProject_ASM(const Mat* image, const Mat* hist, Mat* result);
